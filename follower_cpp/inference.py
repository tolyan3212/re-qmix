...
class FollowerConfigCPP(FollowerInferenceConfig, extra=Extra.forbid):
    ...
    num_process: int = 8
    num_threads: int = 8
    path_to_weights: str = "experiments/follower-lite/"
    preprocessing: str = 'FollowerPreprocessingCPP'
    agents_as_obstacles: float = 0.0
    use_rl: bool = True
...
class FollowerInferenceCPP:
    def __init__(self, cfg: FollowerConfigCPP):
        ...
        self.cpp_config.use_precalc_cost = self.cfg.training_config.preprocessing.use_precalc_cost
        ...
        self.cpp_config.agents_as_obstacles = self.cfg.agents_as_obstacles
